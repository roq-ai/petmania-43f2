...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Pro'];
  const customerRoles: string[] = ['Pet Owner'];
  const tenantRoles: string[] = ['Starter', 'Gainer', 'Pro'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Petmania`;
  const tenantName = `Petopia`;
